...
const skillTreeProps: SkillProps = {
  skillArray: [
    ...
    { type: SkillType.WEB, title: "App Router" },
    { type: SkillType.WEB, title: "Page Router" },
    { type: SkillType.WEB, title: "Tanstack Query" },
    { type: SkillType.WEB, title: "Tanstack Table" },
    { type: SkillType.WEB, title: "Context API" },
    { type: SkillType.WEB, title: "Jotai" },
    { type: SkillType.WEB, title: "Recoil" },
    { type: SkillType.WEB, title: "graphQL" },
    { type: SkillType.WEB, title: "Service Worker" },
    { type: SkillType.WEB, title: "Notification" },
